                ...
                <div class="page">
                    ...
                    <div class="right">
                        ...
                        <div class="right_contentBg" >
							...
							<pre class="pre">
								<code>
									TableRecord tem= new TableRecord
								</code>
							</pre>
							if u want to create new java TabeleRecord 
                        ...
                        <div class="right_contentBg" >
							...
							because maybe U want use number to combine 
